...
export interface CountyData {
  ...
  wardAllocations: WardAllocation[];
}

const NAIROBI_DATA: CountyData = {
  info: {
...
function getPlaceholderData(countyId: string): CountyData {
  const name = getCountyName(countyId);
  return {
    info: {
      name: `${name} County`,
      fiscalYear: "FY 2025/2026",
      totalBudget: 15_000_000_000,
      totalRecurrent: 10_500_000_000,
      totalDevelopment: 4_500_000_000,
      totalWards: 30,
      totalSubCounties: 6,
      totalDepartments: 10,
      governor: "TBD",
      approvalDate: "Pending",
      source: `${name} County Budget Proposals`,
    },
    departments: [
      {
        id: "health",
        name: "Health Services",
        totalAllocation: 4_500_000_000,
        recurrent: 3_150_000_000,
        development: 1_350_000_000,
        previousYear: 4_200_000_000,
        programs: [
          { name: "Primary Healthcare", allocation: 2_000_000_000, description: "Local clinics and community health" },
          { name: "Medical Supplies", allocation: 1_500_000_000, description: "Drugs and hospital equipment" },
        ],
      },
      {
        id: "transport",
        ...
        totalAllocation: 3_000_000_000,
        recurrent: 900_000_000,
        development: 2_100_000_000,
        previousYear: 2_800_000_000,
        programs: [
          { name: "Rural Road Maintenance", allocation: 1_500_000_000, description: "Grading and murraming of feeder roads" },
          { name: "Bridge Construction", allocation: 600_000_000, description: "Small bridges and culverts" },
        ],
      },
    ],
    wardAllocations: [
      {
        ward: "Central Ward", subCounty: "Main Sub-County",
        totalAllocation: 150_000_000,
        breakdown: { health: 45_000_000, roads: 40_000_000, water: 30_000_000, education: 25_000_000, other: 10_000_000 },
        keyProjects: ["Ward Health Clinic — KES 15M", "Market Access Road — KES 12M"],
      }
    ]
  };
}

export function getCountyData(countyId: string): CountyData {
  if (countyId === "47") {
    return NAIROBI_DATA;
  }
  return getPlaceholderData(countyId);
}
